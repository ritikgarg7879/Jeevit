...
const MainDashboard = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Additional Buttons */}
      <TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("Prescription")} style={styles.secondaryButton}>
          <Text style={styles.secondaryButtonText}>My Medications</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("SearchMedicine")} style={styles.secondaryButton}>
